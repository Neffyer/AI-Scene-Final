...
public class Flock : MonoBehaviour {
    ...
    private void ApplyRules()
    {
        ...
        foreach (GameObject go in gos)
        {
            ...
            if (go != this.gameObject)
            {
                ...
                if (mDistance <= FlockingManager.FM.neighbourDistance)
                {
        ...
        if (groupSize > 0)
        {
            ...
            cohesion = cohesion / groupSize + (FlockingManager.FM.goalPos - this.transform.position);
            ...
            Vector3 direction = (cohesion + vAvoid) - transform.position;
    ...
    void Update() {
        ...
        Bounds b = new Bounds(FlockingManager.FM.transform.position, FlockingManager.FM.swimLimits * 1.0f);
